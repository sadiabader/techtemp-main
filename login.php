...
$log = "SELECT * FROM  admin_reg where lemail = '$User_email'";
$res = mysqli_query($conn, $log);

if(mysqli_num_rows($res) > 0){
   $row = mysqli_fetch_assoc($res);
   $db_pass = $row[password];
   $pass_check = password_verify($user_pass, $db_pass);
                  ...
                  <form action="<?php echo $_SERVER['PHP_SELF'];?>" method="post"id="request" class="main_form">
                     <div class="row">
                        ...
                        <label for="email">Email</label>
                           <input class="contactus" placeholder="email" type="text" name="lemail">                          
                        </div>
                        <div class="col-md-12">
                        <label for="pass">Password</label>
                           <input class="contactus" placeholder="password" type="pasword" name="lpassword">                          
                        </div>
