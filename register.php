...
echo "<script> alert('email already exist')</script>";
   ...
   $insert_data = "INSERT INTO `admin_reg` (`name`,`email`,`Password`)VALUES ('$name','$email', '$pass')";
$connect = mysqli_query($conn, $insert_data);


header('location:http://localhost/techtemp-main/login.php');
}
}
?>
<!DOCTYPE html>
                  ...
                  <form action="<?php echo $_SERVER['PHP_SELF'];?>" method="post" id="request" class="main_form">
                     <div class="row">
                        ...
                        <label for="passwprd">Password</label>
                           <input class="contactus" placeholder="password" type="pass" name="Password">                          
                        </div>
